...
export const Avenir = () => {
  ...
  return (
    ...
    />
    <View>
        <Text style={styles.text_footer}>Vous n'avez aucun voyage à venir</Text>
        </View>
        <View>
        <Text  style={styles.content} >Retrouver une réservation effectuée sans s'enregistrer</Text>
        </View>
        <TouchableOpacity
          ...
          >
              <Text style={[styles.textSign, {
                  color:"#FFF"
              }]}>Retrouver une réservation</Text>
          </LinearGradient>
          </TouchableOpacity>
  </View>
  )
